...
## Final Project Tasks :
1. Data will be sourced, downloaded and prepared for analysis.
2. Use a database to house data
3. Apply machine learning to tell a data story
4. Display findings in a dashboard
5. 
